...
@section('content')
    <div class="admin-card">
        <div class="admin-card-header">
            ...
            <button onclick="openLeadershipAddModal()" class="btn-success h-10!">
                <i class="fas fa-plus"></i> Add Leadership
            </button>
        </div>

        <div class="admin-card-body bg-slate-50/20 custom-scrollbar">
            <div id="leadership-sortable-list" class="space-y-3">
                ...
                @empty
                    <div
                        ...
                        <h2 class="text-slate-400!">No Leadership Profile Found</h2>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <div id="addModal" class="modal-overlay hidden">
        <div class="modal-content max-w-5xl! h-[90vh]! flex flex-col">
            ...
            <div class="flex justify-between items-center pb-3 border-b border-slate-100 shrink-0">
                <h1 class="mb-0!">Add New Leadership</h1>
            ...
            <form id="addForm" action="{{ route('admin.leadership.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="grid grid-cols-15 gap-10">
                    <div class="col-span-4 flex flex-col items-center">
                        <label class="text-[11px] font-bold text-slate-400 uppercase mb-1 self-start ml-1">Leadership Photo
                            (3:4)</label>
    ...
    <div id="editModal" class="modal-overlay hidden">
        <div class="modal-content max-w-5xl! h-[90vh]! flex flex-col">
            ...
            <div class="flex justify-between items-center pb-3 border-b border-slate-100 shrink-0">
                <h1 class="mb-0!">Edit Leadership Profile</h1>
            ...
            <form id="editForm" class="flex-1 overflow-y-auto custom-scrollbar px-2 py-6 space-y-6">
                ...
                <div class="grid grid-cols-15 gap-10">
                    <div class="col-span-4">
                        <label class="text-[11px] font-bold text-slate-400 uppercase mb-1 block ml-1">Leadership
                            Photo</label>
            ...
            <div class="flex items-center justify-between border-t border-slate-100 pt-4 shrink-0 bg-white">
                <label class="toggle-switch">
                    ...
                    <span id="leadershipStatusLabel" class="ml-3 font-bold text-slate-600 text-sm">
                        Active
                    </span>
                </label>
