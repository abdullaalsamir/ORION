...
@section('content')
                ...
                @forelse($items as $item)
                    <div class="sortable-item group bg-white border border-slate-200 rounded-2xl p-3 flex items-center hover:border-admin-blue transition-all"
                        ...
                        <div
                            ...
                            <img src="{{ asset('storage/directors/thumbs/' . basename($item->image_path)) }}?v={{ $item->updated_at->timestamp }}"
                        ...
                        <div class="flex items-center border-l pl-4 border-slate-100 space-x-1">
                            <button class="btn-icon w-8 p-1.5!" onclick="openDirectorEditModal({{ json_encode($item) }})">
    ...
    <div id="addModal" class="modal-overlay hidden">
        <div class="modal-content max-w-5xl! h-[90vh]! flex flex-col">
            ...
            <form id="addForm" action="{{ route('admin.directors.store') }}" method="POST" enctype="multipart/form-data"
